...
public class replaceTnt {
    ...
    public replaceTnt(Location loc1, Location loc2) {
        this(loc1.getWorld(), loc1.getBlockX(), loc1.getBlockY(), loc1.getBlockZ(), loc2.getBlockX(), loc2.getBlockY(), loc2.getBlockZ());
    }

    public replaceTnt(World world, int x1, int y1, int z1, int x2, int y2, int z2) {
        this.world = world;
    ...
    public boolean contains(replaceTnt cuboid) {
    ...
    public boolean overlaps(replaceTnt cuboid) {
        return cuboid.getWorld().equals(world) &&
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof replaceTnt)) {
            return false;
        }
        final replaceTnt other = (replaceTnt) obj;
